...
@section('content')
                    ...
                    <div class="col-md-7">
                        <header>
                            @if ($client && isset($invoiceNumber))
                                <h2><a href="{{url('/clients/'.$client->public_id)}}" target="_blank">{{ $client->getDisplayName() }}</a></h2>
    ...
    <div class="row">
        <div class="col-md-12">
            {{ Former::populateField('amount', $amount?:"") }}
            {!! Former::text('amount')
                        ->placeholder(trans('texts.pre_auth_amount'))
                        ->label(trans('texts.pre_auth_amount')) !!}
        </div>
    </div>
    <div class="col-md-12">
    ...
    <center>
        ...
        @endif
        @if(isset($amount))
            {!! Button::success(strtoupper(trans('texts.pre_auth_now')   ))
                            ->submit()
                            ->large() !!}
        @else
